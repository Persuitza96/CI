    <div class="row">
                    <div class="col-8"><form action="/user/create" method="post">
                   <div class="from-grop">
                        <lable>ประเภทผู้ใช้งาน</lable>
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input name="username" type="text" class="form-control" placeholder="กรอกชื่อผู้ใช้งาน">
                    </div>
                    <div class="form-group">
